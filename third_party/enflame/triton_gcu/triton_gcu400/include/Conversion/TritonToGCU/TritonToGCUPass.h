...
#define GEN_PASS_DECL_TRITONGCUREMOVELAYOUTCONVERSIONSPASS
...
#define GEN_PASS_DECL_TRITONGCUOPTIMIZEDOTOPERANDS
...
#define GEN_PASS_DECL_TLELOWERPIPETOGCUWS
#define GEN_PASS_DECL_TRITONGCULOCALMEMOPTIMIZEPASS
#define GEN_PASS_DECL_TRITONGCUINSERTPRODUCERFENCESPASS
#define GEN_PASS_DECL_ANNOTATEDOTACCREUSEPASS
#define GEN_PASS_DECL_ANNOTATEDOTFUSIONPASS
#define GEN_PASS_DECL_ANNOTATEDOTALLOCAREUSEPASS
