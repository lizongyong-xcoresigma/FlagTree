...
timeout ${TIMEOUT} pytest -v python/test/unit/integrations/vllm/chunk_h/test_chunk_fwd_kernel_h.py -o junit_suite_name="test_chunk_h" --junitxml=${LOG_DIR}_xml/___test_chunk_h.xml 2>&1 | tee ${LOG_DIR}/test_chunk_h.log; check_status
